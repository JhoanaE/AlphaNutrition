...
class crudSup extends Conexion {
    ...
    function alta($objSupnat) {
        ...
        $statement->bindParam(7, $objSupnat->fechan); // asegúrate de que el formato de la fecha sea compatible con MySQL
...
$objSupnat = new SupAlta("1", "Dorian70150","Dorian", "Espinoza", "Marquez", "dorian587@gmail.com", "54554854548", "2024-06-29", "M", "dorian1");
$crud = new crudSup();
//$crud->alta($objSupnat);
