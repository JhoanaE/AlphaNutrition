// Suponiendo que tienes una variable que indica si el usuario ha iniciado sesión o no
let userIsLoggedIn = false; // Cambiar a true si el usuario ha iniciado sesión
...
iconCart.addEventListener('click', () => {
    if (!userIsLoggedIn) {
        alert('Debe estar registrado para ver el carrito.');
        return;
    }
...
listProductHTML.addEventListener('click', (event) => {
    ...
    if(positionClick.classList.contains('addCart')){
        if (!userIsLoggedIn) {
            alert('Debe estar registrado para agregar productos al carrito.');
            return;
        }
